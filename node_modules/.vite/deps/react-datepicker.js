...
function isTimeInDisabledRange(time, _ref13) {
  ...
  var min2 = setHours(setMinutes(base, getMinutes(minTime2)), getHours(minTime2));
  var max2 = setHours(setMinutes(base, getMinutes(maxTime2)), getHours(maxTime2));
  var valid;
  try {
